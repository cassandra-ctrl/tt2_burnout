// ModalAgendarCita - Modal para crear nueva cita
import { useState, useEffect } from 'react';
import citasService from '../services/citasService';
import SuccessModal from './SuccessModal';
import './ModalAgendarCita.css';

const ModalAgendarCita = ({ isOpen, onClose, idPaciente, nombrePaciente, onCitaCreada }) => {
  ...
  const seleccionarDia = (dia) => {
    ...
    // Actualizar formData con la fecha en formato YYYY-MM-DD
    const año = mesActual.getFullYear();
  ...
  const cambiarMes = (direccion) => {
    ...
    setDiaSeleccionado(null); // Reset día seleccionado al cambiar mes
  };
  ...
  return (
    <>
      ...
      <SuccessModal
        ...
        title="¡Cita Agendada!"
        message={`La cita con ${nombrePaciente} ha sido agendada exitosamente.`}
        type="success"
      />
    </>
  );
